...
const routes = [
  ...
  { path: '/companies', name: 'Companies', component: () => import('../views/companies/Index.vue'), meta: { auth: true } },
  {
    ...
    children: [
      ...
      { path: 'invoices/:invoiceId/edit', name: 'InvoiceEdit', component: () => import('../views/invoices/Edit.vue') },
      { path: 'invoices/:invoiceId/receive', name: 'InvoiceReceive', component: () => import('../views/invoices/Receive.vue') },
      ...
      { path: 'bills/:billId', name: 'BillShow', component: () => import('../views/bills/Show.vue') },
      { path: 'bills/:billId/edit', name: 'BillEdit', component: () => import('../views/bills/Edit.vue') },
      { path: 'bills/:billId/pay', name: 'BillPay', component: () => import('../views/bills/Pay.vue') },
