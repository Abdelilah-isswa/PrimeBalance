      ...
      <div v-if="!isViewer" class="pb-sidebar anim-fade-in">
        <div class="pb-card pb-options-card">
          ...
          <div class="pb-option-list">
            <router-link
              v-if="bill?.status !== 'paid' && Number(bill?.transactions_count || 0) === 0"
            ...
            <div v-else-if="bill?.status !== 'paid'" style="color:#64748b; font-size:13px; font-weight:600; padding:10px 12px;">
              Bills linked to transactions cannot be edited.
            </div>
